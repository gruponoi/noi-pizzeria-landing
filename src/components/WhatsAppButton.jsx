...
function WhatsAppButton() {
  return (
    <WhatsAppLink ctaLocation="floating_button" ctaLabel="Pedir" className="whatsapp-float" href={whatsappUrl} target="_blank" rel="noreferrer" aria-label="Pedir por WhatsApp">
